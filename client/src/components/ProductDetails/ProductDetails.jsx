...
function ProductDetail() {
    ...
    useEffect(() => {
        const url = 'https://bit-kart.onrender.com/getProduct/' + p.productId;
        axios.get(url)
            .then((res) => {
    ...
    const HandleContact = (addedBy) => {
        const url = 'https://bit-kart.onrender.com/getUser/' + addedBy;
        axios.get(url)
            .then((res) => {
                if (res.data.user) {
            ...
            <h2>PRODUCT DETAILS:</h2>
                    {product &&<div className="product-details">
                       <div className="product-images">
                            <img src={"https://bit-kart.onrender.com/" + product.Pimage} alt="" />
                            {product.Pimage2 && <img src={"https://bit-kart.onrender.com/" + product.Pimage2} alt="" />}
